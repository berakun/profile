        ...
        <div className="bg-zinc-700 w-screen h-screen flex flex-col items-center justify-center text-left text-black">
            <form>
                ...
                <div class="flex items-start mb-6">
                    ...
                    <label for="terms" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="/termsandcondition" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label>
                </div>
